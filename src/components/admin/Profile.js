...
function Profile({ setShowProfile }) {
  ...
  return (
    <div className=" mt-2 px-5 py-10 bg-white z-50 rounded-bl-md">
      <div className="flex flex-col justify-center items-start  h-full space-y-5">
        ...
        <button className="w-full flex justify-center items-center space-x-2 border p-1 rounded-md px-2">
